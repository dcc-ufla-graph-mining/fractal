...
2. Build the system by following the steps in README-fractal.md.

3.  Download input graphs used in the experiments:
    https://drive.google.com/drive/folders/1VLs8mpsqono2Q6FWq4Fj13grKLZ2uJSN
...
This example runs the Densest Subgraph objective function on the dblp graph, using 16 cores, with 100 initial solutions of size 10, a random seed, and a 1-second time limit per solution.
