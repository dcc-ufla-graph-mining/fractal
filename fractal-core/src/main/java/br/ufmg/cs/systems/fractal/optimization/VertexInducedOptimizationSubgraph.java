...
public class VertexInducedOptimizationSubgraph implements Externalizable {
    ...
    private double cost;
    private transient MainGraph underlyingGraph; // graph from which this subgraph is part of
    ...
    private final IntArrayListView reusableVertexNeighbors = new IntArrayListView();
    private final IntArrayListView reusableEdgeNeighbors = new IntArrayListView();
     ...
     * @param subgraph
     */
    public VertexInducedOptimizationSubgraph(VertexInducedSubgraph subgraph, SerializableToDoubleFunction<VertexInducedOptimizationSubgraph> objectiveFunction) {
        ...
        // Create adjacency lists for each vertex and populate the set of vertices
    ...
    private void accessVertexNeighborhood(int vertex, IntArrayListView vneighbors, IntArrayListView eneighbors) {
    ...
    public void neighborhoodVertices(int vertex, IntArrayListView reusableVertexNeighbors) {
        underlyingGraph.neighborhoodVertices(vertex, reusableVertexNeighbors);
    }
    ...
    public void neighborhoodEdges(int vertex, IntArrayListView reusableEdgeNeighbors) {
        underlyingGraph.neighborhoodEdges(vertex, reusableEdgeNeighbors);
    }
    ...
    private void addVertex(int vertex) {
        accessVertexNeighborhood(vertex, reusableVertexNeighbors, reusableEdgeNeighbors);
        IntIntMap adjList = HashIntIntMaps.newMutableMap();

        if (adjLists.containsKey(vertex)) {
            throw new RuntimeException("Vertex " + vertex + " is already in the subgraph!");
        }
        ...
        for (int i = 0; i < reusableVertexNeighbors.size(); i++) {
            ...
            if (neighborAdjList != null) {
                adjLists.get(vertex).put(vertexNeighbor, edge);
                neighborAdjList.put(vertex, edge);
                this.numEdges++;
            }
        }
     ...
     */
    public void addAndSetCost(int vertex, double cost) {
        addVertex(vertex);
        setCost(cost);
    }
     ...
     * @param vertex vertex to be added
     */
    public void addAndRecalculateCost(int vertex) {
        addVertex(vertex);
...
//   }
    ...
    private void removeVertex(int vertex) {
        ...
        if (!adjLists.containsKey(vertex)) {
            throw new RuntimeException("Vertex " + vertex + " is not in the subgraph!");
        }
     ...
     * @param vertex vertex to be removed
     */
    public void removeAndRecalculateCost(int vertex) {
        removeVertex(vertex);
        recalculateCost();
    }
     ...
     * @param cost   new subgraph cost
     */
    public void removeAndSetCost(int vertex, double cost) {
        removeVertex(vertex);
        setCost(cost);
    }
